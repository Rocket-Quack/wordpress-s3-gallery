    ...
    <div class="wrap">
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr><th>Endpoint URL</th>
                    <td><input type="text" name="s3_gallery_endpoint" value="<?php echo esc_attr(get_option('s3_gallery_endpoint')); ?>"></td></tr>
                <tr><th>Region</th>
                    <td><input type="text" name="s3_gallery_region" value="<?php echo esc_attr(get_option('s3_gallery_region')); ?>"></td></tr>
                <tr><th>Bucket</th>
                    <td><input type="text" name="s3_gallery_bucket" value="<?php echo esc_attr(get_option('s3_gallery_bucket')); ?>"></td></tr>
                <tr><th>Access Key</th>
                    <td><input type="text" name="s3_gallery_key" value="<?php echo esc_attr(get_option('s3_gallery_key')); ?>"></td></tr>
                <tr><th>Secret Key</th>
                    <td><input type="password" name="s3_gallery_secret" value="<?php echo esc_attr(get_option('s3_gallery_secret')); ?>"></td></tr>
            </table>
            <?php submit_button(); ?>
        </form>
    </div>
